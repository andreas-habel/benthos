...
:::
Publishes messages to a Solace PubSub+ Message Broker
...
output:
  ...
  solace:
    endpoint:
      queue_name: my/queue # No default (optional)
      topic_name: my/dynamic/topic # No default (required)
    max_in_flight: 64
    transport:
